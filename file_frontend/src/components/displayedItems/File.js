...
const File = (props) => {
  ...
  return (
    <div className={cssVersion.main} onClick={() => {mode === 'main' ? selectItem({path:title,type:'file'}) : selectItemModal({path:title,type:'file'})}}>
        <img className={cssVersion.img} src="https://i.ibb.co/mRptnRc/file.png" alt="file" border="0"></img>
...
export default connect(null,{selectItem,selectItemModal})(File)